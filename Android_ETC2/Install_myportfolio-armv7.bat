...
if "%ANDROIDHOME%"=="" set ANDROIDHOME=C:/Users/Saman/Documents/ANDROIDSDK
...
%ADB% %DEVICE% install myportfolio-armv7.apk
@if "%ERRORLEVEL%" NEQ "0" goto Error
%ADB% %DEVICE% shell rm -r %STORAGE%/UE4Game/myportfolio
%ADB% %DEVICE% shell rm -r %STORAGE%/UE4Game/UE4CommandLine.txt
%ADB% %DEVICE% shell rm -r %STORAGE%/obb/com.YourCompany.myportfolio
%ADB% %DEVICE% shell rm -r %STORAGE%/Android/obb/com.YourCompany.myportfolio
%ADB% %DEVICE% shell rm -r %STORAGE%/Download/obb/com.YourCompany.myportfolio
